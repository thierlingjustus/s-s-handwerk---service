    ...
    <div className="pt-32 pb-20 px-6 max-w-7xl mx-auto relative z-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 tracking-tight">Entrümpelung & Entsorgung</h1>
          <p className="text-lg md:text-xl text-slate-600 mb-8 leading-relaxed">
            Ob Wohnung, Haus, Keller oder Gewerbe – wir sorgen für eine schnelle, fachgerechte Entrümpelung inklusive gründlicher Reinigung. Schnell, professionell und diskret.
          </p>
        ...
        >
          <div className="relative w-full max-w-[360px] md:max-w-md aspect-square md:aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl border-8 border-white transition-all duration-700 ease-out group-hover:scale-[1.02] hover:shadow-[0_30px_60px_rgba(0,0,0,0.15)]">
            ...
            <img 
              src="https://images.unsplash.com/photo-1513694203232-719a280e022f?q=90&w=1600&auto=format&fit=crop" 
              alt="Entrümpelung und saubere Räume" 
      ...
      >
        ...
        <div className="relative z-10">
          <h2 className="text-2xl font-bold text-slate-900 mb-6">Warum S&S für Ihre Entrümpelung?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h4 className="font-semibold text-[#1a4a7c] mb-2">Schnell & Diskret</h4>
              <p className="text-slate-600 text-sm">Wir arbeiten zügig und respektieren Ihre Privatsphäre, besonders bei sensiblen Haushaltsauflösungen.</p>
            </div>
            <div>
              <h4 className="font-semibold text-[#1a4a7c] mb-2">Besenreine Übergabe</h4>
              <p className="text-slate-600 text-sm">Wir räumen nicht nur aus, sondern hinterlassen die Räumlichkeiten sauber und übergabebereit.</p>
            </div>
            <div>
              <h4 className="font-semibold text-[#1a4a7c] mb-2">Zertifizierte Entsorgung</h4>
              <p className="text-slate-600 text-sm">Mülltrennung und fachgerechte Entsorgung auf Recyclinghöfen sind für uns Standard.</p>
            </div>
          </div>
        </div>
      </motion.div>
