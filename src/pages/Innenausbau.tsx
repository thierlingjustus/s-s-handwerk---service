...
const subServices = [
  "Trockenbau & Deckenabhängungen",
  "Bodenverlegung (Laminat, Vinyl, etc.)",
    ...
    <div className="pt-32 pb-20 px-6 max-w-7xl mx-auto relative z-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 tracking-tight">Innenausbau & Renovierung</h1>
          <p className="text-lg md:text-xl text-slate-600 mb-8 leading-relaxed">
            Wir übernehmen sämtliche Arbeiten rund um den Innenausbau und die Renovierung Ihrer Wohn- oder Gewerberäume – sauber, zuverlässig und termingerecht. Modernes Raumdesign trifft auf höchste Funktionalität.
          </p>
        ...
        >
          <div className="relative w-full max-w-[360px] md:max-w-md aspect-square md:aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl border-8 border-white transition-all duration-700 ease-out group-hover:scale-[1.02] hover:shadow-[0_30px_60px_rgba(0,0,0,0.15)]">
            ...
            <img 
              src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=90&w=1600&auto=format&fit=crop" 
              alt="Innenausbau & Renovierung" 
      ...
      >
        ...
        <div className="relative z-10">
          <h2 className="text-2xl font-bold text-slate-900 mb-6">Warum S&S für Ihren Innenausbau?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h4 className="font-semibold text-[#1a4a7c] mb-2">Sauberkeits-Garantie</h4>
              <p className="text-slate-600 text-sm">Wir hinterlassen jede Baustelle besenrein. Staubschutzmaßnahmen sind für uns selbstverständlich.</p>
            </div>
            <div>
              <h4 className="font-semibold text-[#1a4a7c] mb-2">Alles aus einer Hand</h4>
              <p className="text-slate-600 text-sm">Von der Demontage bis zum finalen Anstrich koordinieren wir alle Gewerke nahtlos.</p>
            </div>
            <div>
              <h4 className="font-semibold text-[#1a4a7c] mb-2">Präzise Planung</h4>
              <p className="text-slate-600 text-sm">Detaillierte Aufmaße und transparente Festpreise schützen Sie vor bösen Überraschungen.</p>
            </div>
          </div>
        </div>
      </motion.div>
